<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Role','name'=>'role','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Role","name"=>"role","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
