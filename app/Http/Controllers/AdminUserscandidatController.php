<?php namespace App\Http\Controllers;
	...
	class AdminUserscandidatController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "Candidat";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Role","name"=>"role_id","join"=>"roles,name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Role','name'=>'role_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable_where'=>'select (*) from users where role_id=2'];
			...
			$this->form[] = ['label'=>'Ville','name'=>'ville_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'ville,id'];
