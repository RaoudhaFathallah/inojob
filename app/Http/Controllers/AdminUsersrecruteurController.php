<?php namespace App\Http\Controllers;
	...
	class AdminUsersrecruteurController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Role Id','name'=>'role_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'role,id'];
			...
			$this->form[] = ['label'=>'Ville Id','name'=>'ville_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'ville,id'];
